...
// Period options shown in the picker.
...
// pollIntervalMs is how often the history panel refreshes when showing today.
...
export function FocusHistory() {
  ...
  useEffect(() => {
    ...
    // Only poll continuously for "today" since it includes live data.
      ...
      <div className={styles.body}>
        ...
        {data && data.total_seconds > 0 ? (
          <div className={styles.totalLine}>
            Total: {formatDuration(data.total_seconds)}
          </div>
        ) : null}
      </div>
    </div>
